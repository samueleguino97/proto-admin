...
function abs(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('math::abs', args, _.spec, [
    {args: [{typeId: "f9461c25-7cce-11ed-ad6a-6b0596217fa9", optional: false, setoftype: false, variadic: false}], returnTypeId: "f9461c25-7cce-11ed-ad6a-6b0596217fa9"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
type var_07b83da07ccf11edb947dd2ccf6405c8λFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
> = $.$expr_Function<
  _std.$number, $.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
type var_07b83da07ccf11edb947dd2ccf6405c8λFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>,
> = $.$expr_Function<
 ...
 */
function var_07b83da07ccf11edb947dd2ccf6405c8<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
>(
  vals: P1,
): var_07b83da07ccf11edb947dd2ccf6405c8λFuncExpr<P1>;
/**
 * Return the sample variance of the input set.
 */
function var_07b83da07ccf11edb947dd2ccf6405c8<
...
>(
  vals: P1,
): var_07b83da07ccf11edb947dd2ccf6405c8λFuncExpr2<P1>;
function var_07b83da07ccf11edb947dd2ccf6405c8(...args: any[]) {
...
type __defaultExports = {
  ...
  "var": typeof var_07b83da07ccf11edb947dd2ccf6405c8;
...
const __defaultExports: __defaultExports = {
  ...
  "var": var_07b83da07ccf11edb947dd2ccf6405c8,
  "var_pop": var_pop
};
