...
const JsonEmpty: $JsonEmpty = $.makeType<$JsonEmpty>(_.spec, "fee7d964-7cce-11ed-b9d7-0ffff730c44d", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "f94db89c-7cce-11ed-8479-f93aff1dce4e", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "007c0ded-7ccf-11ed-85ef-cdb1ba391830", _.syntax.literal);
...
export type $Object_008214927ccf11eda8a2756e5970bb5fλShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_008214927ccf11eda8a2756e5970bb5f = $.ObjectType<"std::Object", $Object_008214927ccf11eda8a2756e5970bb5fλShape, null, [
  ...$BaseObject['__exclusives__'],
]>;
export type $Object = $Object_008214927ccf11eda8a2756e5970bb5f
const $Object_008214927ccf11eda8a2756e5970bb5f = $.makeType<$Object_008214927ccf11eda8a2756e5970bb5f>(_.spec, "00821492-7ccf-11ed-a8a2-756e5970bb5f", _.syntax.literal);

const Object_008214927ccf11eda8a2756e5970bb5f: $.$expr_PathNode<$.TypeSet<$Object_008214927ccf11eda8a2756e5970bb5f, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Object_008214927ccf11eda8a2756e5970bb5f, $.Cardinality.Many), null);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "00895c47-7ccf-11ed-8126-918eb94dba03", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "f9461c25-7cce-11ed-ad6a-6b0596217fa9", optional: false, setoftype: true, variadic: false}], returnTypeId: "f9461c25-7cce-11ed-ad6a-6b0596217fa9", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "f94e73ec-7cce-11ed-8f9f-99b83d4d15b2", optional: false, setoftype: true, variadic: false}], returnTypeId: "f94e73ec-7cce-11ed-8f9f-99b83d4d15b2", returnTypemod: "OptionalType", preservesOptionality: true},
...
function contains(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::contains', args, _.spec, [
    ...
    {args: [{typeId: "75b29098-c660-ef4e-9cc1-619e71f3b8c5", optional: false, setoftype: false, variadic: false}, {typeId: "75b29098-c660-ef4e-9cc1-619e71f3b8c5", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
    {args: [{typeId: "75b29098-c660-ef4e-9cc1-619e71f3b8c5", optional: false, setoftype: false, variadic: false}, {typeId: "f93f73ea-7cce-11ed-b0fc-114030c57795", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
...
function range_is_empty(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_is_empty', args, _.spec, [
    {args: [{typeId: "75b29098-c660-ef4e-9cc1-619e71f3b8c5", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function range_get_upper(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_get_upper', args, _.spec, [
    {args: [{typeId: "75b29098-c660-ef4e-9cc1-619e71f3b8c5", optional: false, setoftype: false, variadic: false}], returnTypeId: "f93f73ea-7cce-11ed-b0fc-114030c57795", returnTypemod: "OptionalType"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "03f1d6c8-7ccf-11ed-8e64-c35540117b3e", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "03f1d6c8-7ccf-11ed-8e64-c35540117b3e", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { JsonEmpty, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_008214927ccf11eda8a2756e5970bb5f, Object_008214927ccf11eda8a2756e5970bb5f, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_008214927ccf11eda8a2756e5970bb5f;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_008214927ccf11eda8a2756e5970bb5f,
